...
//                $query['FailureURL'] = $settings->getFullFormFailureUrl();
                $query['SuccessURL'] = "http://rentabag.dev/VspPHPKit/demo/form/success";
                $query['FailureURL'] = "http://rentabag.dev/VspPHPKit/demo/form/failure";
//0||$notpr||print  "<pre> \$settings->getFullFormFailureUrl() :".$s1
//      .$s1 . print_r($settings->getFullFormFailureUrl(), 1)."\n"
//      ."</pre>";$notpr;
