...
class Paymentsense_Paymentsense_Block_Threedsecure extends Mage_Core_Block_Abstract
{
	/**
	...
	protected function _toHtml()
    {
    	...
    	{
    		$szTermURL = 'Paymentsense/payment/callbacktransparentredirect';
    	}
    	else
    	{
    		$szTermURL = 'Paymentsense/payment/callback3d';
    	}
